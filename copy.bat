...
copy /b ..\..\github\lichkin-projects-report\lichkin-projects-report-employee-ui\src\main\resources\META-INF\resources\res\js\employee\report\index\i18n\zh_CN.js report-zh_CN.js
